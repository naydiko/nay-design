...
/**
 * REST API for user registration and self-service profile management.
 *
 ...
 * never hard-deleted while they may own projects — deactivate them via
 * {@link UpdateUserRequest#status()} instead.
 */
@Tag(name = "Users")
@RestController
...
public class UserController {
    ...
    @Operation(summary = "Update a user's profile or status")
    @PutMapping("/{id}")
